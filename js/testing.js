...
function testCreating(){
	...
	addElementAndGroup(treeData[0],"Client1",["name", "System2", "type","System"]);
		...
		addElementAndGroup(treeData[0],"System2",["name", "BTS2-5", "type","BTS"]);
			addElementAndGroup(treeData[0],"BTS2-5",["name", "bla1", "type","Something1"]);
			// addElementAndGroup(treeData[0],"BTS2-5",["name", "bla2", "type","Something1"]);
			// addElementAndGroup(treeData[0],"BTS2-5",["name", "bla3", "type","Something1"]);
			// addElementAndGroup(treeData[0],"BTS2-5",["name", "bla4", "type","Something2"]);
			// addElementAndGroup(treeData[0],"BTS2-5",["name", "bla5", "type","Something2"]);
			// addElementAndGroup(treeData[0],"BTS2-5",["name", "bla6", "type","Something2"]);
